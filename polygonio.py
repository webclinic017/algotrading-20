...
class warrantOps():
    ...
    def __init__(self, val):
        ...
        self.dt_cboe = getDate.query('cboe')
        self.construct_fpaths(self, val, self.dt, self.base_dir)
    ...
    @classmethod
    def if_iex_eod_exists(cls, self, val):
        ...
        if not isinstance(self.df, pd.DataFrame):
            try:
                ...
                pass
            wt_df.to_json(self.wt_fpath, compression='gzip')
            self.df = wt_df.to_json(orient='records')
